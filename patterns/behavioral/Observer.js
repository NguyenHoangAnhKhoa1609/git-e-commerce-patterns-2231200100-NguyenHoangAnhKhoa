...
class OrderTracker {
    ...
    addObserver(observer) {
        ...
        console.log(`[OrderTracker] Added observer: ${observer.constructor.name}`);
    }

    removeObserver(observer) {
        // TODO: Remove the observer from the `this.observers` array.
        this.observers =  this.observers.filter(o=> o !== observer);
        console.log(`[OrderTracker] Removed observer: ${observer.constructor.name}`);
    }
    ...
    notifyObservers() {
        ...
        console.log(`[OrderTracker] Notifying ${this.observers.length} observer(s)...`);
